...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * ,----------------------------------------------------------------.
   * |Esc | 1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  +|  ´|Backspa |Hme|
   * |----------------------------------------------------------------|
   ...
   */
	...
	[_BL] = LAYOUT_65_iso( 
		...
		KC_LCTL,            KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_RBRC,  KC_ENT,   KC_PGUP,
    ...
    _______,            _______,  KC_UP,    M_EMAIL,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            KC_INS,
    _______,            KC_LEFT,  KC_DOWN,  KC_RIGHT, _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_HOME,
    RGB_TOG,  RGB_MOD,  RGB_HUI,  RGB_HUD,  RGB_SAI,  RGB_SAD,  RGB_VAI,  RGB_VAD,  KC_VOLD,  KC_VOLU,  KC_MUTE,  _______,            KC_BTN1,  KC_MS_U,  KC_BTN2,
