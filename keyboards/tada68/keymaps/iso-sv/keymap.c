...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = LAYOUT_iso(
    ...
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, NO_APOS, KC_ENT,  KC_PGUP, \
...
[_FL] = LAYOUT_ansi(
  ...
  _______,  _______,  KC_UP,    EMAIL_ADD,_______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_INS, \
