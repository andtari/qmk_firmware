...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * `----------------------------------------------------------------'
   *
   * Mouse: KC_BTN1, KC_BTN2, KC_MS_L, KC_MS_R, KC_MS_U, KC_MS_D
   * 
   */
  ...
  [_FL] = LAYOUT_iso(
    ...
    _______,  _______,  _______,  BL_DEC,   BL_TOGG,  BL_INC,   _______,  KC_VOLD,  KC_VOLU,  KC_MUTE,  _______,  _______,  KC_BTN1,  KC_MS_U,  KC_BTN2,
